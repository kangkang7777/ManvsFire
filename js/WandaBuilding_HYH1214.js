...
$(function () {
    ...
    workerLoadSmokeAndPath.postMessage("../SmokeData/wanda.json");
    ...
    function init() {
        ...
        camControlOver.center = new THREE.Vector3(0,0,90);
        ...
        var totalFloor = new THREE.Mesh(new THREE.BoxGeometry(500,1,300),new THREE.MeshBasicMaterial({color:0x9caeba}));
        totalFloor.position.set(0,-1,0);
    ...
    mapWorker.onmessage = function (event) {
        ...
        (function drawWallCube() {
            for(let key in mapInfoMap){
                var index1 = key.indexOf('&');
                var vsgX = Number(key.substring(0,index1));
                var index2 = key.lastIndexOf('@');
                var vsgZ = Number(key.substring(index1+1,index2));
                var vsgY = Number(key.substring(index2+1));
                let guidCube = new THREE.Mesh(new THREE.CubeGeometry( 1, 1, 1 ),new THREE.MeshBasicMaterial({color:0xFF0000}));
                guidCube.position.set(vsgX,vsgY,vsgZ);
                scene.add(guidCube);
            }
            for(let i=0; i<exitInfoMap['2'].length;i++){
                let guidCube = new THREE.Mesh(new THREE.CubeGeometry( 1, 1, 1 ),new THREE.MeshBasicMaterial({color:0x00FFFF}));
                guidCube.position.set(exitInfoMap['2'][i][1],exitInfoMap['2'][i][2],exitInfoMap['2'][i][3]);
                scene.add(guidCube);
            }
        });
    ...
    function initFollowerAndLeader(mesh) {
        ...
        for(var i=0; i<blendMeshArr.length; i++){
            ...
            if(bestIndex!==-1){
                ...
                // var index = blendMeshArr[i].position.x + "&" +blendMeshArr[i].position.z+'@1';
                humanInfoMap[index]=0;
                pathControlMap[index] = pathControl;
            }else{
        ...
        while(getLeaderArr.length != blendMeshArr.length){
            ...
            for(var i=0; i<unGetLeaderArr.length; i++){
                ...
                if(bestIndex!==-1){
                    ...
                    // var index = unGetLeaderArr[i].position.x + "&" +unGetLeaderArr[i].position.z+'@1';
                    humanInfoMap[index]=0;
                    pathControlMap[index] = pathControl;
    ...
    function createRandomPos(meshNum) {
        ...
        var blendMeshPosIndexArr = ["96&-20@1","-113&-35@1","-169&90@1","-15&90@1","169&85@1"];
...
//                    console.log(pathTag + "count is:" +iterationCountMap[pathTag]);
    ...
    document.getElementById('submitBtn').addEventListener('click',function (evet) {
        ...
        meshTotalCount =defaultMeshNum;
        createNav();
        mapWorker.postMessage("../SmokeData/Block_Map_WD.txt");
        document.getElementById("toNo1").style.display="none";
        document.getElementById("toNo2").style.display="none";
    ...
    //触屏UI控制开始-------冯玉山
    // var isready=false
    // document.getElementById('left').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('left').addEventListener('mousedown',function _handlemosedownL(){
    //     camControl.lon=camControl.lon-0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handlemosedownL()})
    //     }
    // },false);
    // document.getElementById('left').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('up').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('up').addEventListener('mousedown',function _handlemousedownU(){
    //     camControl.lat=camControl.lat+0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handlemousedownU()})
    //     }
    // });
    // document.getElementById('up').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('down').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('down').addEventListener('mousedown',function _handlemousedownD(){
    //     camControl.lat=camControl.lat-0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handlemousedownD()})
    //     }
    // });
    // document.getElementById('down').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('right').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('right').addEventListener('mousedown',function _handlemousedownR(){
    //     camControl.lon=camControl.lon+0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handlemousedownR()})
    //     }
    // });
    // document.getElementById('right').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('forward').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('forward').addEventListener('mousedown',function _handlemousedownF(){
    //     var step=1;
    //     var angle=camera.getWorldDirection();
    //     camera.position.add(angle.multiplyScalar(step));
    //     if(isready)
    //     {
    //         requestAnimationFrame(function(){_handlemousedownF()})
    //     }
    // },false);
    // document.getElementById('forward').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('back').addEventListener('mousedown',function(){isready=true},false);
    // document.getElementById('back').addEventListener('mousedown',function _handlemousedownB(){
    //     var step=-1;
    //     var angle=camera.getWorldDirection();
    //     camera.position.add(angle.multiplyScalar(step));
    //     if(isready)
    //     {
    //         requestAnimationFrame(function(){_handlemousedownB()})
    //     }
    // },false);
    // document.getElementById('back').addEventListener('mouseup', function() {isready=false}, false);
    // document.getElementById('left').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('left').addEventListener('touchstart',function _handletouvhstartL(){
    //     camControl.lon=camControl.lon-0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handletouvhstartL()})
    //     }
    // },false);
    // document.getElementById('left').addEventListener('touchend', function() {isready=false}, false);
    // document.getElementById('up').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('up').addEventListener('touchstart',function _handletouchstartU(){
    //     camControl.lat=camControl.lat+0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handletouchstartU()})
    //     }
    // });
    // document.getElementById('up').addEventListener('touchend', function() {isready=false}, false);
    // document.getElementById('down').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('down').addEventListener('touchstart',function _handletouchstartD(){
    //     camControl.lat=camControl.lat-0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handletouchstartD()})
    //     }
    // });
    // document.getElementById('down').addEventListener('touchend', function() {isready=false}, false);
    // document.getElementById('right').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('right').addEventListener('touchstart',function _handletouchstartR(){
    //     camControl.lon=camControl.lon+0.5
    //     if(isready)
    //     {
    //         requestAnimationFrame(function () {_handletouchstartR()})
    //     }
    // });
    // document.getElementById('right').addEventListener('touchend', function() {isready=false}, false);
    // document.getElementById('forward').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('forward').addEventListener('touchstart',function _handletouchstartF(){
    //     var step=1;
    //     var angle=camera.getWorldDirection();
    //     camera.position.add(angle.multiplyScalar(step));
    //     if(isready)
    //     {
    //         requestAnimationFrame(function(){_handletouchstartF()})
    //     }
    // },false);
    // document.getElementById('forward').addEventListener('touchend', function() {isready=false}, false);
    // document.getElementById('back').addEventListener('touchstart',function(){isready=true},false);
    // document.getElementById('back').addEventListener('touchstart',function _handletouchstartB(){
    //     var step=-1;
    //     var angle=camera.getWorldDirection();
    //     camera.position.add(angle.multiplyScalar(step));
    //     if(isready)
    //     {
    //         requestAnimationFrame(function(){_handletouchstartB()})
    //     }
    // },false);
    // document.getElementById('back').addEventListener('touchend', function() {isready=false}, false);
    //触屏UI结束------冯玉山
