...
THREE.TongFPS = function ( object, domElement ) {
    this.isChange=false;
    ...
    this.update = function( delta ) {
        ...
        {
            if(Math.abs(this.object.rotation.z * 180 /Math.PI) > 90) {
                var v1 = new THREE.Vector3(0,0,1);
                var horizontalRotation = new THREE.Euler(Math.PI,this.object.rotation.y,this.object.rotation.z,'XYZ');
            }
            else{
                var v1 = new THREE.Vector3(0,0,-1);
                var horizontalRotation = new THREE.Euler(Math.PI,-this.object.rotation.y,this.object.rotation.z,'XYZ');
