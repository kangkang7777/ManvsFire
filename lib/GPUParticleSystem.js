...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load("textures/perlin2-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load("textures/particle3.png");
...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
	...
	this.init = function() {
		var hyhPointMat = new THREE.PointsMaterial({color:0x535353});
		self.particleSystem = new THREE.Points(self.particleShaderGeo, self.particleShaderMat);
		// self.particleSystem = new THREE.Points(self.particleShaderGeo, hyhPointMat);
	...
	this.spawnParticle = function(options) {
		...
		colorRandomness = options.colorRandomness !== undefined ? options.colorRandomness : 0.0;
