...
THREE.OrbitControls = function ( object, domElement ) {
    ...
    function onMouseMove( event ) {
        ...
        } else if ( state === STATE.PAN && this.userPan) {
    ...
    function onMouseWheel( event ) {
        ...
        //
        // if( event.deltaY < 0 ){
        //     object.position.x += vector.x * factor;
        //     object.position.y += vector.y * factor;
        //     object.position.z += vector.z * factor;
        //     scope.center.x += vector.x * factor;
        //     scope.center.y += vector.y * factor;
        //     scope.center.z += vector.z * factor;
        // } else{
        //     object.position.x -= vector.x * factor;
        //     object.position.y -= vector.y * factor;
        //     object.position.z -= vector.z * factor;
